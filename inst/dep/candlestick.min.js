...
(function($) {
    ...
    Candlestick.prototype.wrapElement = function () {
        ...
        if (this.settings.fa==1) {
            $classes += ' candlestick-fa';
            $classes_cont = " candlestick-size-" + this.settings.size
        }

        switch (this.settings.mode) {
            case 'contents':
                var html = '<div class="candlestick-wrapper candlestick-contents'+ $classes_cont +'"><div data-candlestick-id="' + $id + '" class="candlestick-bg' + $classes + '"><div class="candlestick-toggle" style="background-color:' +
                this.settings.contents_color +';"></div><div class="candlestick-off" data-content="' + this.settings.contents.left + '"></div>';
    ...
    Candlestick.prototype.setHandle = function (cursor) {
        ...
        if (cursor == 0) {
            ...
            if(outerWidth == 0){
              left = 2.5 * this.parent.find('.candlestick-toggle').outerWidth();
    ...
    Candlestick.prototype.defaultOrganization = function () {
        ...
        console.log(candlestickBgWidth);
        console.log(candlestickToggleWidth);
        if(candlestickBgWidth == 0){
          candlestickBgWidth = 138;
        }
        if(candlestickBgHeight == 0){
          candlestickBgHeight = 45;
        }
        this.handle.css({
