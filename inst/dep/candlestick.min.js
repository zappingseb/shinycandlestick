...
(function($) {
    ...
    Candlestick.prototype.wrapElement = function () {
        ...
        switch (this.settings.mode) {
            case 'contents':
                var html = '<div class="candlestick-wrapper candlestick-contents'+ $classes_cont +'"><div data-candlestick-id="' + $id + '" class="candlestick-bg' + $classes + '"><div class="candlestick-toggle"></div><div class="candlestick-off" data-content="' + this.settings.contents.left + '"></div>';
